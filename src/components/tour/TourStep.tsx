...
export function TourStep() {
  ...
  return (
    <>
      {/* Spotlight overlay */}
      <TourSpotlight target={currentStep.target} allowOutsideClick={false} />

      {/* Beacon indicator for click steps */}
      {showBeacon && !stepCompleted && (
        <TourBeacon target={currentStep.target} label="Click here" />
      )}
      ...
      <TourPopover
        ...
        title={
          stepCompleted && currentStep.celebration
