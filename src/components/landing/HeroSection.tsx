...
export function HeroSection() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden px-4 pb-0 pt-20"
    >
      {/* Animated Background Orbs - Tighter spread */}
      <motion.div
      ...
      <div className="relative z-10 mx-auto flex max-w-6xl flex-col items-center gap-12 px-6 lg:flex-row lg:items-center lg:gap-16">
        {/* Text Content - Compact Typography */}
        <motion.div
        ...
        >
          ...
          >
            ...
            sketches to Python turtle graphics.
          </motion.p>
        ...
        {/* Live Demo Preview - Compact & Modern */}
        <motion.div
          className="relative w-full max-w-[600px] lg:flex-[1.2]"
          style={{ y: previewY }}
        ...
        >
          ...
          {/* Preview Container - 16:10 Laptop Ratio */}
          <motion.div className="relative aspect-[16/10] w-full overflow-hidden rounded-xl border border-white/10 bg-zinc-900/90 shadow-2xl backdrop-blur-sm">
            {/* Minimal Window Chrome */}
            <div className="flex h-9 items-center gap-1.5 border-b border-white/5 bg-white/5 px-3">
