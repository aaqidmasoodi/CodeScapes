        ...
        {!isAuthenticated ? (
          ...
          <>
            <DialogHeader>
              ...
              <DialogDescription>
                Create an account or sign in to start building your projects.
              </DialogDescription>
            </DialogHeader>
            <div className="flex flex-col items-center gap-6 py-8">
              ...
              <div className="text-center">
                ...
                <p className="mt-1 text-sm text-muted-foreground">
                  Sign in to create and save your projects, access cloud storage, and share with the
                  community.
                </p>
              </div>
                    ...
                    <div className="mt-2 space-y-1 text-sm">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium">
                          {ENVIRONMENTS[selectedEnv].templates.find(
