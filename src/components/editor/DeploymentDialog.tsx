                ...
                <div className="flex flex-col gap-4 py-4">
                    ...
                    <div className="flex items-center justify-between rounded-lg border p-4 bg-muted/50">
                        <div className="space-y-0.5">
                            <h4 className="font-medium text-sm">Deploy New Version</h4>
                    ...
                    <div className="space-y-2">
                        ...
                        <ScrollArea className="h-[200px] rounded-md border p-2">
                            {isLoadingHistory ? (
                                ...
                                <p className="text-center text-xs text-muted-foreground p-4">No deployments yet.</p>
                            ) : (
                                <div className="space-y-2">
                                    {deployments.map((dep, i) => (
                                        <div key={dep.id} className="flex items-center justify-between p-2 rounded-md hover:bg-muted/50 transition-colors">
                                            <div className="flex items-center gap-3">
                                                <div className="flex h-8 w-8 items-center justify-center rounded-full bg-primary/10 text-primary font-mono text-xs font-bold">
                                                    v{dep.version}
                                                </div>
                                                <div className="flex flex-col">
                                                    ...
                                                    <span className="text-[10px] text-muted-foreground flex items-center gap-1">
                                                        <Clock className="h-3 w-3" /> {new Date(dep.created_at).toLocaleString()}
                                                    </span>
                                                </div>
                                            </div>
