 ...
 *
 * @example
 * const { success, limit, remaining } = await rateLimit(req, "cors-proxy", 60)
 ...
 *
 * @param req - The request object (must have headers)
 * @param prefix - Unique prefix for this rate limit (e.g., "cors-proxy")
